...
contract decisionmaking { // This line begins the declaration of a Solidity contract named "decisionmaking".
    uint oranges = 4; // This line declares a variable named "oranges" of type uint (unsigned integer) and initializes its value to 4.
    function validateoranges() public view returns(bool){ /*This line declares a function named "validateoranges" that takes no parameters and returns a boolean value. 
...
*/
    ...
    function airDrop() public view returns (uint) { // This line declares a function named "airDrop" that takes no parameters and returns a uint value. The "public" keyword indicates that the function can be called externally by anyone, and the "view" keyword indicates that the function does not modify the contract state.
        if (stakingwallet == 10) {
